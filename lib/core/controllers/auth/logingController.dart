  ...
  loginByEmailAndPassword(BuildContext context)async
  {
        try {
          ...
          if(FirebaseAuth.instance.currentUser!.emailVerified)
          {
            ...
            CustomAwesomeDialog(context: context,text:"Check your email to allow going to home page.",animType: AnimType.topSlide ).show();
          }
        } on FirebaseAuthException catch (e) {
          if (e.code == 'user-not-found') {
            CustomAwesomeDialog(context: context,text:"No user found for that email.",animType: AnimType.topSlide ).show();
          } else if (e.code == 'wrong-password') {
            CustomAwesomeDialog(context: context,text:"Wrong password provided for that user.",animType: AnimType.topSlide ).show();
          }
          else{
            CustomAwesomeDialog(context: context,text:"Check your email and password",animType: AnimType.topSlide ).show();
          }
        }catch(e)
        {
